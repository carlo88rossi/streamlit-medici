...
# ---------- CALLBACK PULSANTI RAPIDI --------------------------------------------
def toggle_specialisti():
    """Alterna tra default_spec e spec_extra"""
...
# ---------- PULSANTI RAPIDI ----------------------------------------------------
st.button("Specialisti 👨‍⚕️👩‍⚕️", key="btn_specialisti", on_click=toggle_specialisti)
st.button("MMG + PED 🩺",           key="btn_mmg_ped",     on_click=set_mmg_ped)
...
if st.checkbox("🔔 FREQUENZA", value=False, key="filtro_frequenza") and "frequenza" in df_mmg.columns:
